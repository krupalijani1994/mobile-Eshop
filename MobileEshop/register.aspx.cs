...
public partial class _register : System.Web.UI.Page
{
	...
	protected void btnregister_Click(object sender, EventArgs e)
	{
        ...
        String qry = "insert into tbl_register(fname,lname,address,postcode,city,username,password,gender,email,phoneno,dob)values('" + txtfname.Text + "','" + txtlname.Text + "','" + txtadd.Text + "','" + txtpostcode.Text + "','" + drpcity.Text + "','" + txtusername.Text + "','" + hashedPassword + "','" + rabgender.Text + "','" + txtemail.Text + "','" + txtcontno.Text + "','" + txtdob.Text + "')";
